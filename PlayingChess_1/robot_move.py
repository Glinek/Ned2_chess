...
class RobotBoard:
    def __init__(self):
        ...
        self.pick_poses = count_board_pick_coordinates("board_poses4.txt")
    ...
    def do_move(self, move, capture, piece_to_move, piece_to_capture):
        ...
        if piece_to_move == 6 and (str(move) == "e8g8" or str(move) == "e8c8" or str(move) == "e1g1" or str(move) == "e1c1"):
            if str(move) == "e8g8":
                ...
                self.do_move("a8d8", False, chess.ROOK, 0)
            elif str(move) == "e1g1":
                self.do_move("h1f1", False, chess.ROOK, 0)
            else:
                self.do_move("a1d1", False, chess.ROOK, 0)
